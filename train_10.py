import pandas as pd
import numpy as np
from myModelFactory_10 import ModelFactory
...
from callback_10 import MultipleClassAUROC, MultiGPUModelCheckpoint
...
model.compile(optimizer=Adam(lr=3e-5), loss="binary_crossentropy", metrics=['acc'])
