...
class MultipleClassAUROC(Callback):
    ...
    """
    def __init__(self, base_model, sequence, valid_y, class_names, weights_path, stats=None, workers=1):
    ...
    def on_epoch_end(self, epoch, logs={}):
        ...
        if mean_auroc > self.stats["best_mean_auroc"]:
            ...
            print("*********************************")
            self.base_model.save(os.path.join(os.path.split(self.weights_path)[0],sys.argv[3],), overwrite=True)
        return
