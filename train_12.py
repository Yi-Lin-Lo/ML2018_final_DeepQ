import pandas as pd
import numpy as np
from myModelFactory_12 import ModelFactory
...
from callback_12 import MultipleClassAUROC, MultiGPUModelCheckpoint
...
model.compile(optimizer=Adam(lr=5e-5), loss="binary_crossentropy", metrics=['acc'])
...
modelcheckpoint = ModelCheckpoint('./model/' + model_name,mode='min',monitor='val_loss',save_best_only=True)
