import pandas as pd
import numpy as np
from myModelFactory_5 import ModelFactory
...
for layer in model.layers:
   ...
   #     layer.trainable = False
    ...
    if hasattr(layer, 'kernel_regularizer'):
        layer.kernel_regularizer= regularizers.l2(0.002)
        layer.kernel_regularizer= regularizers.l1(0.002)
...
modelcheckpoint = ModelCheckpoint('./model/unuse.h5',mode='min',monitor='val_loss')
